...
![Go Backend Clean Architecture](https://go_be_clean_architecture/blob/main/assets/go-backend-clean-architecture.png?raw=true)
...
![Go Backend Clean Architecture Diagram](https://go_be_clean_architecture/blob/main/assets/go-backend-arch-diagram.png?raw=true)
...
![Public API Request Flow](https://go_be_clean_architecture/blob/main/assets/go-arch-public-api-request-flow.png?raw=true)

### Private API Request Flow with JWT Authentication Middleware

> JWT Authentication Middleware for Access Token Validation.

![Private API Request Flow](https://go_be_clean_architecture/blob/main/assets/go-arch-private-api-request-flow.png?raw=true)
...
git clone https://go_be_clean_architecture.git
...
<a href="https://documenter.getpostman.com/view/391588/2s8Z75S9xy" target="_blank">
    <img alt="View API Doc Button" src="https://go_be_clean_architecture/blob/main/assets/button-view-api-docs.png?raw=true" width="200" height="60"/>
</a>
